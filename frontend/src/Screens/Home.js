  ...
  return (
    <div className="flex">
      <div className="h-screen bg-white w-1/3 shadow-xl pr-10 pl-7 ">
        ...
        >
          <div className="pt-1 text-green font-semibold text-sm flex justify-between">
            Goldbees <span className="ml-3">5.09%</span>
            <span>42.21</span>
          </div>
          <div className="pt-1 text-red font-semibold text-sm flex justify-between">
            HDFC Bank <span>-3.36%</span>
            <span>1518.6</span>
          </div>
          <div className="pt-1 text-green font-semibold text-sm flex justify-between">
            Tata Power <span className="ml-3">9.09%</span>
            <span>42.21</span>
          </div>
          <div className="pt-1 text-red font-semibold text-sm flex justify-between">
            Future Retail <span>-4.36%</span>
            <span>1518.6</span>
          </div>
        </div>
      ...
      <div className="w-full px-20">
        ...
        <Iframe
          src="https://in.investing.com/indices/s-p-cnx-nifty-chart"
